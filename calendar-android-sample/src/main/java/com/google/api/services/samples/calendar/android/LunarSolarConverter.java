...
class Lunar {
	...
	/**
	 * @param lunarDay the lunarDay to set
	 */
	...
	/**
	 * @param lunarMonth the lunarMonth to set
	 */
	...
	/**
	 * @param lunarYear the lunarYear to set
	 */
	...
	public String toString() {
		...
		return lunarYear + "-" + lunarMonth + "-" + lunarMonth;
	}
}
...
class Solar {
	...
	@Override
	public String toString() {
		return "solarYear" + solarYear + "-solarMonth-" + solarMonth + "-solarYear=" + solarDay;
	}
}
...
public class LunarSolarConverter {
	...
	*/
	public static Lunar SolarToLunar(Solar solar) {
		...
		lunar.setRepeat(solar.getRepeat());
		lunarD = (int) (offset);
